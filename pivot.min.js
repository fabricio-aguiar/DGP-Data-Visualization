(function() {
    ...
    (t = function(t) {
        ...
        return i = function(t, e, n) {
            ...
            return {
                "Contagem": t.count(x),
                "Contagem de Valores Únicos": t.countUnique(x),
                "Lista de Valores únicos": t.listUnique(", "),
                "Soma": t.sum(A),
                "Soma de Inteiros": t.sum(x),
                "Média": t.average(A),
                "Mediana": t.median(A),
                "Variância Amostral": t["var"](1, A),
                "Desvio Padrão": t.stdev(1, A),
                "Mínimo": t.min(A),
                "Máximo": t.max(A),
                "Primeiro": t.first(A),
                "Último": t.last(A),
                "Soma sobre Soma": t.sumOverSum(A),
                "Limite Superior a 80%": t.sumOverSumBound80(!0, A),
                "Limite Inferior a 80%": t.sumOverSumBound80(!1, A),
                "Soma como Fração do Total": t.fractionOf(t.sum(), "total", S),
                "Soma como Fração da Linha": t.fractionOf(t.sum(), "row", S),
                "Soma como Fração da Coluna": t.fractionOf(t.sum(), "col", S),
                "Contagem como Fração do Total": t.fractionOf(t.count(), "total", S),
                "Contagem como Fração da Linha": t.fractionOf(t.count(), "row", S),
                "Contagem como Fração da Coluna": t.fractionOf(t.count(), "col", S)
            }
        }(s), b = {
            "Tabela": function (t, e) {
                return g(t, e)
            },
            "Tabela com Barras": function(e, n) {
                return t(g(e, n)).barchart()
            },
            "Mapa de Calor": function(e, n) {
                return t(g(e, n)).heatmap("heatmap", n)
            },
            "Mapa de Calor por Linhas": function(e, n) {
                return t(g(e, n)).heatmap("rowheatmap", n)
            },
            "Mapa de Calor por Colunas": function(e, n) {
            ...
            try {
                ...
                for (M = {
                        key_a_to_z: {
                            rowSymbol: "Crescente - Nome das Linhas",
                            colSymbol: "Crescente - Nome das Colunas",
                            next: "value_a_to_z"
                        },
                        value_a_to_z: {
                            rowSymbol: "Crescente - Valor das Linhas",
                            colSymbol: "Crescente - Valor das Colunas",
                            next: "value_z_to_a"
                        },
                        value_z_to_a: {
                            rowSymbol: "Decrescente - Valor das Linhas",
                            colSymbol: "Decrescente - Valor das Colunas",
                            next: "key_a_to_z"
                        }
                    }, B = t("<a>", {
                        role: "button"
